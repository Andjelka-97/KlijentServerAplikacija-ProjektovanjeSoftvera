...
public class ModelTabeleStavki extends AbstractTableModel{
    ...
    public void dodajStavku(Proizvod proizvod, Narudzbenica narudzbenica) {
        ...
        if (stavka != null) {
            ...
            stavka = new StavkaNarudzbenice(lista.size() + 1,narudzbenica, 1, proizvod.getCena(), proizvod);
            lista.add(stavka);
        }
        postaviIznos();
        fireTableDataChanged();
